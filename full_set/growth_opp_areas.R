...
out.file.nm <- "79_dist_growth_opp_areas" 
...
ofm.file.nm <- "../data//tract_population_households.csv"
...
emp.dir <- "/Volumes/DataTeam/Projects/V2050/SEIS/Data_Support/script_input"
